...
ControllerAll = false
local ListSudos ={Sudo_Id,1951693700,5298947457}
...
if UserId == 1951693700 then
Status = 'مبرمج السورس'
elseif UserId == 1951693700 then
Status = 'مطور السورس'
...
MsgText = 'فديت المتفاعل'
elseif tonumber(Message) < 3500 then 
MsgText = 'دك تفاعل'
elseif tonumber(Message) < 4000 then 
MsgText = 'موش تفاعل ضيمم'
...
MsgText = 'تفاعلك برو ماكس'
elseif tonumber(Message) < 10000000000 then 
MsgText = 'متفاعل اكثر من البوت'
end 
return MsgText 
end
...
if tonumber(msg.sender.user_id) ~= tonumber(1951693700) then
JoinChannel = false 
end
end
end 
...
if tonumber(msg.sender.user_id) == 1951693700 then
msg.Name_Controller = 'المبرمج '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 1951693700 then
...
return send(msg_chat_id,msg_id,'-اطلق دمطي ['..UserInfo.first_name..'](tg://user?id='..msg.sender.user_id..')\n-نورت الكروب {'..Get_Chat.title..'}',"md")  
end
end
end
...
local N = (Redis:get(black.."Name:Bot") or "خالد")
...
{
{text = '- Source Brothers -', url = 't.me/M_D_I'},
}
}
...
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"- نزلتة خلي يجيب العربانة 🙃 ").Reply,"md",true)  
else
Redis:srem(black.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"-  تم حبي جيب العربانة🌚 ").Reply,"md",true)  
end
end
if TextMsg == "صاك" then
if not Redis:sismember(black.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"- تم من زمان طلع اجكم🙃 ").Reply,"md",true)  
else
Redis:srem(black.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"- تم التنزيل يلا ولي وصخ ").Reply,"md",true)  
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"-الكلب هذا بطل هوهوه ونزلناه  🙃 ").Reply,"md",true)  
else
...
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"-الحمار هذا عقل من زمان   🙃 ").Reply,"md",true)  
else
Redis:srem(black.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"- تم تنزيله من الحمير تعال نفك الحبل منك😂🌚 ").Reply,"md",true)  
end
end
if TextMsg == "زاحف" then
if not Redis:sismember(black.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"-بطل يمشي ورا النسوان 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(black.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"- تم تنزيله لازم ياخذ دروس رجوله😂🌚 ").Reply,"md",true)  
end
end
if TextMsg == "قرد" then
if not Redis:sismember(black.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"-بطل يطنط ع الشجر 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(black.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"- تم تنزيله من قائمه القرود تعالو نزلو من الشجره😂🌚 ").Reply,"md",true)  
end
end
if TextMsg == "عطواني" then
if not Redis:sismember(black.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"-ﻻ صار رجال").Reply,"md",true)  
else
Redis:srem(black.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"-تم نزلتة لايتموع بعد").Reply,"md",true)  
end
end
if TextMsg == "غبي" then
if not Redis:sismember(black.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"-يارب تعقل وتصي ذكي 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(black.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"-تم بس شغل عقلك ").Reply,"md",true)  
end
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"- محطوط ب القائمة من زمان ").Reply,"md",true)  
else
Redis:sadd(black.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"- تم ترقيته مطي بالمجموعة   ").Reply,"md",true)  
end
end
if TextMsg == "صاك" then
if ChannelJoin(msg) == false then
...
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"الحلوو مرفوع").Reply,"md",true)  
else
Redis:sadd(black.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"-  تستاهل بصراحة تترفع صاك  ").Reply,"md",true)  
end
end
if TextMsg == "متوحد" then
if ChannelJoin(msg) == false then
...
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"-   موجود هذا  ").Reply,"md",true)  
else
Redis:sadd(black.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"- تم رفعتة النفسية        ").Reply,"md",true)  
end
end
if TextMsg == "متوحده" then
if ChannelJoin(msg) == false then
...
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"-  مربوط من زمان ").Reply,"md",true)  
else
Redis:sadd(black.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"-  تم جيبو حبل").Reply,"md",true)  
end
end
if TextMsg == "حمار" then
if ChannelJoin(msg) == false then
...
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"- ديحمل حاليا").Reply,"md",true)  
else
Redis:sadd(black.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"- تم رفعتة خيجرب صوته ").Reply,"md",true)  
end
end
if TextMsg == "زاحف" then
if ChannelJoin(msg) == false then
...
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"-نزلناه من زمان واخذ كورسات رجوله   ").Reply,"md",true)  
else
Redis:sadd(black.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"- تم رفعه زاحف في الكروب  ").Reply,"md",true)  
end
end
if TextMsg == "قرد" then
if ChannelJoin(msg) == false then
...
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"- تم رفعه قرد في الكروب").Reply,"md",true)  
end
end
if TextMsg == "عطواني" then
if ChannelJoin(msg) == false then
...
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"- ديتمكيج حاليا ").Reply,"md",true)  
else
Redis:sadd(black.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"- تم رفعه خليه يتموع  ").Reply,"md",true)  
end
end
if TextMsg == "غبي" then
if ChannelJoin(msg) == false then
...
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"-  موجود  ").Reply,"md",true)  
else
...
if #Info_Members == 0 then
return send(msg_chat_id,msg_id,"- لا يوجد مطيات حاليا , ","md",true)  
end
ListMembers = '\n*- قائمه المطيات  \n ــــــــــــــــــــــ-ـــــــــــــــــــــ*\n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '- مسح المطيات', data = msg.sender.user_id..'/Delkholat'},},}}
return send(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
if text == 'صاك' then
if ChannelJoin(msg) == false then
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '- مسح المطاية', data = msg.sender.user_id..'/Delwtk'},},}}
return send(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
if #Info_Members == 0 then
return send(msg_chat_id,msg_id,"-  كلهم اتعالجو , ","md",true)  
end
ListMembers = '\n*- قائمه المتوحدين  \n ــــــــــــــــــــــ-ـــــــــــــــــــــ*\n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
...
if #Info_Members == 0 then
return send(msg_chat_id,msg_id,"-    خلصناا ولله , ","md",true)  
end
ListMembers = '\n*- قائمه الكلاب  \n ــــــــــــــــــــــ-ـــــــــــــــــــــ*\n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
...
if #Info_Members == 0 then
return send(msg_chat_id,msg_id,"-ماكو حمير هنا  , ","md",true)  
end
ListMembers = '\n*- قائمه الحمير  \n ــــــــــــــــــــــ-ـــــــــــــــــــــ*\n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
...
if #Info_Members == 0 then
return send(msg_chat_id,msg_id,"-   صارو زلم , ","md",true)  
end
ListMembers = '\n*- قائمه العطواني  \n ــــــــــــــــــــــ-ـــــــــــــــــــــ*\n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '- مسح العطواني', data = msg.sender.user_id..'/Del3ra'},},}}
return send(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
if #Info_Members == 0 then
return send(msg_chat_id,msg_id,"-   طردناهم كلهم , ","md",true)  
end
ListMembers = '\n*- قائمه الزواحف  \n ــــــــــــــــــــــ-ـــــــــــــــــــــ*\n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '- مسح الزواحف', data = msg.sender.user_id..'/Delsmb'},},}}
return send(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
if text == 'القرود' then
if ChannelJoin(msg) == false then
...
if #Info_Members == 0 then
return send(msg_chat_id,msg_id,"-   خلصوو , ","md",true)  
end
ListMembers = '\n*- قائمه القرود  \n ــــــــــــــــــــــ-ـــــــــــــــــــــ*\n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
...
if #Info_Members == 0 then
return send(msg_chat_id,msg_id,"-    صارو يفتهمون , ","md",true)  
end
ListMembers = '\n*- قائمه الاغبيه  \n ــــــــــــــــــــــ-ـــــــــــــــــــــ*\n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
...
if UserId == "1951693700" then
return send(msg_chat_id,msg_id,"\n*- عذرآ لا تستطيع استخدام الامر على المبرمج  *","md",true)  
end
...
send(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"- تم قفـل دمطي الاعضاء").Lock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"- تم فتح دمطي الاعضاء").unLock,"md",true)  
return false
end 
...
if TextMsg == 'المطاية' then
local Info_Members = Redis:smembers(black.."kholat:Group"..msg_chat_id) 
if #Info_Members == 0 then
return send(msg_chat_id,msg_id,"- لا يوجد مطاية حاليا , ","md",true)  
end
Redis:del(black.."kholat:Group"..msg_chat_id) 
return send(msg_chat_id,msg_id,"*- تم مسح {"..#Info_Members.."} من المطيات *","md",true)
end
...
local Info_Members = Redis:smembers(black.."8by:Group"..msg_chat_id) 
if #Info_Members == 0 then
return send(msg_chat_id,msg_id,"- لا يوجد حاليا , ","md",true)  
end
Redis:del(black.."8by:Group"..msg_chat_id) 
return send(msg_chat_id,msg_id,"*- تم مسح {"..#Info_Members.."} من الاغبيه *","md",true)
end
if TextMsg == 'العطواني' then
local Info_Members = Redis:smembers(black.."3ra:Group"..msg_chat_id) 
if #Info_Members == 0 then
return send(msg_chat_id,msg_id,"- لا يوجد عطواني حاليا , ","md",true)  
end
Redis:del(black.."3ra:Group"..msg_chat_id) 
return send(msg_chat_id,msg_id,"*- تم مسح {"..#Info_Members.."} من العطواني *","md",true)
end
if TextMsg == 'الزواحف' then
local Info_Members = Redis:smembers(black.."smb:Group"..msg_chat_id) 
if #Info_Members == 0 then
return send(msg_chat_id,msg_id,"- لا يوجد زواحف حاليا , ","md",true)  
end
Redis:del(black.."smb:Group"..msg_chat_id) 
return send(msg_chat_id,msg_id,"*- تم مسح {"..#Info_Members.."} من الزواحف *","md",true)
end
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/M_D_I'}, },}}
return send(msg.chat_id,msg.id,'*\n- عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
  ...
  if Redis:sismember(black..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
    ...
    return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,rd_mtzwga[math.random(#rd_mtzwga)]).Reply,"md",true)  
      ...
      local rd_zwag = {
        ...
        "لولولولويي تم الزواج ",
        "مبروك منك المال ومنها العيال",
        "تم زواجكم يلا ع الغرفة",
        "الزواج تم ع كيفكم وي الجرباية "
      }
...
if text == "طلاق" or text == "تنزيل زوجتي" or text == "تزيل زوجي" and msg.reply_to_message_id ~= 0 then
  ...
  local UserInfo = LuaTele.getUser(Message_Reply.sender.user_id)
  if tonumber(Message_Reply.sender.user_id) == tonumber(msg.sender.user_id) then
    return send(msg_chat_id,msg_id,"يطلك نفسه المطي","md",true)  
  end
  if tonumber(Message_Reply.sender.user_id) == tonumber(black) then
    return send(msg_chat_id,msg_id,"روح وليدي روح","md",true)  
  end
  if Redis:sismember(black..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
...
if text == "زخرفه" then
  ...
  return send(msg_chat_id,msg_id, "مرحبا بك في زخرفه خالد","md",false,false,false,false,reply_markup)
end
-- z eng
...
if text == 'ابو هتون' or text == 'خالد'  then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
{text = ' - KHALED -', url = 't.me/E_M_K'}, 
},
}
}
return send(msg_chat_id,msg_id,"[- KHALED -](tg://user?id=1951693700)","md",true, false, false, true, reply_markup)
end
...
if msg.Dev then
if photo.total_count > 0 then
return LuaTele.sendPhoto(msg.chat_id, msg.id, photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id,"*نسبه جمالك هي 900% لان مطور ولازم ادلعك😹♥*", "md")
else
...
if text == "توكن" then
if msg.sender.user_id == tonumber(1951693700) then
send(1951693700,msg_id,Token,"html",true)
end
end
if text == "منو اني" then
if msg.sender.user_id == tonumber(1951693700) then
send(msg_chat_id,msg_id,"- انت خالد مبرمج السورس يقلبي🌚♥","md",true)
elseif msg.sender.user_id == tonumber(6666) then
...
{{text = ' - Source Brothers -', url = "https://t.me/M_D_I"}},
}
}
return send(msg_chat_id,msg_id, [[*
...
if text == "رفع بكلبي" then
  ...
  return send(msg_chat_id,msg_id," كلبك عاطل","md")
elseif tonumber(Message_Reply.sender.user_id) == tonumber(msg.sender.user_id) then
  return send(msg_chat_id,msg_id,"انت غبي ترفع نفسك  ؟؟","md")
...
elseif Redis:get(black..msg_chat_id..Message_Reply.sender.user_id.."in_heart:") then
  return send(msg_chat_id,msg_id," للاسف العضو  بكلب غيرك","md")
elseif tonumber(Redis:get(black..msg_chat_id..Message_Reply.sender.user_id.."in_heart:")) ~= tonumber(msg.sender.user_id) and not Redis:get(black..msg_chat_id..Message_Reply.sender.user_id.."in_heart:") then
    ...
    return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"تم رفعه بكلبك").Reply,"md",true)  
  end
end
if text == "تنزيل من كلبي" then 
  ...
  if tonumber(Redis:get(black..msg_chat_id..Message_Reply.sender.user_id.."in_heart:")) == tonumber(msg.sender.user_id) then
    ...
    return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"تم تنزيله من كلبك").Reply,"md",true) 
elseif tonumber(Message_Reply.sender.user_id) == tonumber(msg.sender.user_id) then
  return send(msg_chat_id,msg_id,"انت غبي تنزل نفسك من كلبك ؟؟","md")
elseif tonumber(Message_Reply.sender.user_id) == tonumber(black) then
  return send(msg_chat_id,msg_id,"ابعد عني ","md")
elseif tonumber(Redis:get(black..msg_chat_id..Message_Reply.sender.user_id.."in_heart:")) ~= tonumber(msg.sender.user_id)then
  return send(msg_chat_id,msg_id,"هو  اصلا مو بكلبك ؟؟","md")
  end
end
if text == "اني بكلب منو" then
  if not Redis:get(black..msg_chat_id..msg.sender.user_id.."in_heart:") then
    return send(msg_chat_id,msg_id," دنجب محد يحبك","md")
  elseif Redis:get(black..msg_chat_id..msg.sender.user_id.."in_heart:") then
    ...
    return send(msg_chat_id,msg_id,"انت بكلب ["..heart_name.."](tg://user?id="..in_heart_id..")","md")
  end
end
if text == "تاك للبكلبي" or text == "تاك للي بكلبي" or text == "تاك للناس الي بكلبي" then
  local heart_list = Redis:smembers(black..msg_chat_id..msg.sender.user_id.."my_heart:")
  if #heart_list == 0 then
    return send(msg_chat_id,msg_id,"كلبك فارغ  ","md")
  elseif #heart_list > 0 then
    your_heart = "الناس الي بكلبك \nــــــــــــــــــــــ-ـــــــــــــــــــــ\n"
...
if text == "مسح للبكلبي" or text == "مسح للي بكلبي" then 
...
return send(msg_chat_id,msg_id,"تم مسح الي بكلبك","md")
end
-------
-- ttgwzine
if text == "تعطيل زواج" or text == "تعطيل زوجني" then
if not msg.Manger then
...
if text == "تفعيل زواج" or text == "تفعيل زوجني" then
if not msg.Manger then
return sendx(msg_chat_id,msg_id,'\n*- هذا الامر يخص  '..Controller_Num(6)..' * ',"md",true)  
end
...
if text == "زواج" or text == "زوجني" then
...
return send(msg_chat_id,msg_id,"  ماعدنا توكل","md")
end
local reply_markup = LuaTele.replyMarkup{
  type = 'inline',
  data = {
...
return send(msg_chat_id,msg_id," جبتلك مره صاكةة"..mem_tag.." شرايك ييها ؟؟","md",false, false, false, false, reply_markup)
end
end
...
if text == "زوجتي" then
  ...
  elseif not Redis:get(black..msg_chat_id..msg.sender.user_id.."mtzwga:") then
    return send(msg_chat_id,msg_id," دكعد انت سنكل ","md")
  end
end
if text == "زوجي" then
  if Redis:get(black..msg_chat_id..msg.sender.user_id.."mtzwga:") then
    local zwga_id = Redis:get(black..msg_chat_id..msg.sender.user_id.."mtzwga:")
    local zwga_name = LuaTele.getUser(zwga_id).first_name
    return send(msg_chat_id,msg_id,"تعال يا ["..zwga_name.."](tg://user?id="..zwga_id..") مريتك تريدك","md")
  elseif not Redis:get(black..msg_chat_id..msg.sender.user_id.."mtzwga:") then
    return send(msg_chat_id,msg_id,"دكعدي محد مكلبج ","md")
  end
end
if text == "انتي طالق" and  msg.reply_to_message_id ~= 0 then 
  local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
if tonumber(Message_Reply.sender.user_id) == tonumber(msg.sender.user_id) then
  return send(msg_chat_id,msg_id,"انت غبي تريد تطلك نفسك ؟؟","md")
elseif tonumber(Message_Reply.sender.user_id) == tonumber(black) then
  return send(msg_chat_id,msg_id,"ابعد عني ","md")
...
LuaTele.sendAudio(msg_chat_id,msg_id,'./intk'..rand..'.mp3',tostring(inoi),"html",nil,tostring(inoi),"@M_D_I")
sleep(1)
...
send(msg.chat_id,msg.id, "حوالة صادرة من بنك خالد\n\nالمرسل : "..news.."\nالحساب رقم : `"..cccc.."`\nنوع البطاقة : "..uuuu.."\nالمستلم : "..newss.."\nالحساب رقم : `"..text.."`\nنوع البطاقة : "..fsvhh.."\nخصمت 10% رسوم تحويل\nالمبلغ : "..UserNameyy.." دينار 💵","md",true)
send(fsvhhh,0, "حوالة واردة من بنك خالد\n\nالمرسل : "..news.."\nالحساب رقم : `"..cccc.."`\nنوع البطاقة : "..uuuu.."\nالمبلغ : "..UserNameyy.." دينار 💵","md",true)
Redis:del(black.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id) 
Redis:del(black.."transn" .. msg.sender.user_id)
else
send(msg.chat_id,msg.id, "•  مافيه حساب بنكي كذا","md",true)
...
return send(msg.chat_id,msg.id,"•  انت بالسجن انتضر 🏤  ( "..time_ex.." )","md",true)
end
...
send(msg.chat_id,msg.id, "•  لزمتك الشرطة وانت تزرف 🚔\n✦","md",true)
end
else
send(msg.chat_id,msg.id, "•  ماعنده حساب بنكي ","md",true)
end
...
local jobs = {"طيار","محامي","دكتور","خباز","مدير بنك","قلب خالد","مدرس","فتاحه"}
...
return send(msg_chat_id,msg_id,'*هآي تع اشرب جااي • 😹💔*',"md",false, false, false, false, reply_markup)
end
...
return send(msg_chat_id,msg_id,'*مع الف سلامه يكلبي بعد لاتجي  😹💔🎶*',"md",false, false, false, false, reply_markup)
end
...
return send(msg_chat_id,msg_id,'*  صادها الوتي  *',"md",false, false, false, false, reply_markup)
end
...
return send(msg_chat_id,msg_id,'* نزل عينك لاموتك*',"md",false, false, false, false, reply_markup)
end
if text == '🙄' or text == '🙄🙄' then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
return send(msg_chat_id,msg_id,'*  شبيك *',"md",false, false, false, false, reply_markup)
end
if text == '😂' or text == '😂😂' then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
return send(msg_chat_id,msg_id,'*ضحكتك عثل   🌝❤️*',"md",false, false, false, false, reply_markup)
end
if text == '😹' or text == '😹' then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
return send(msg_chat_id,msg_id,'*  شتفكر 🤔*',"md",false, false, false, false, reply_markup)
end
if text == '🌚' or text == '🌝' then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
return send(msg_chat_id,msg_id,'*  يشبهك الكمر 🙂❤️*',"md",false, false, false, false, reply_markup)
end
if text == '😭' or text == '😭😭' then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
return send(msg_chat_id,msg_id,'* ليش تبجي؟  *',"md",false, false, false, false, reply_markup)
end
if text == '🥺' or text == '🥺🥺' then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
return send(msg_chat_id,msg_id,'*  فدوة*',"md",false, false, false, false, reply_markup)
end
if text == '😒' or text == '😒😒' then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
return send(msg_chat_id,msg_id,'*عدل وجهك    *',"md",false, false, false, false, reply_markup)
end
...
return send(msg_chat_id,msg_id,'*   امووت علييك*',"md",false, false, false, false, reply_markup)
end
...
return send(msg_chat_id,msg_id,'*   لاتسكتني لابنعال *',"md",false, false, false, false, reply_markup)
end
...
return send(msg_chat_id,msg_id,'*دووم ياحبيبي 🌝❤️*',"md",false, false, false, false, reply_markup)
end
if text == 'خ' or text == ' تع ح' then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
return send(msg_chat_id,msg_id,'*     لاعييب*',"md",false, false, false, false, reply_markup)
end
if text == 'خاصخ' or text == 'دز خاص' then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
return send(msg_chat_id,msg_id,'*  كمشتكك يازاحف*',"md",false, false, false, false, reply_markup)
end
...
return send(msg_chat_id,msg_id,'*  امشيك بيها وليدي*',"md",false, false, false, false, reply_markup)
end
...
return send(msg_chat_id,msg_id,'*بخيرر الحمد لله*',"md",false, false, false, false, reply_markup)
end
if text == 'شونكم' or text == 'شلونكم' then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
return send(msg_chat_id,msg_id,'*  يهلاا احنا بخير وانت؟*',"md",false, false, false, false, reply_markup)
end
...
return send(msg_chat_id,msg_id,'  عندي اسم 🥺💔',"md",false, false, false, false, reply_markup)
end
...
return send(msg_chat_id,msg_id,'*لا عيب  😹💔*',"md",false, false, false, false, reply_markup)
end
if text == 'جنت نايم' or text == 'توني كاعد ' then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
return send(msg_chat_id,msg_id,'* نورك ي كلبي 🌝💙*',"md",false, false, false, false, reply_markup)
end
if text == 'باي' or text == 'يلا باي ' then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
return send(msg_chat_id,msg_id,'* لاتروحح 🥺💔*',"md",false, false, false, false, reply_markup)
end
...
return send(msg_chat_id,msg_id,'*  صاير مثقف 😒😹*',"md",false, false, false, false, reply_markup)
end
if text == 'ههههه' or text == 'هههه' then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
return send(msg_chat_id,msg_id,'* تدوومم*',"md",false, false, false, false, reply_markup)
end
if text == 'شكرا' or text == 'مشكور' then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
return send(msg_chat_id,msg_id,'*انت الحلو ياكمر 🤤🌝*',"md",false, false, false, false, reply_markup)
end
if text == 'حموت' or text == 'متت' then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
return send(msg_chat_id,msg_id,'*تمام*',"md",false, false, false, false, reply_markup)
end
if text == 'لش' or text == 'ليش' then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
return send(msg_chat_id,msg_id,'*احسن *',"md",false, false, false, false, reply_markup)
end
...
return send(msg_chat_id,msg_id,'*  يهلا نورتت 🙂❤️*',"md",false, false, false, false, reply_markup)
end
if text == 'هلاوو' or text == 'هيلاو ' then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
return send(msg_chat_id,msg_id,'*  يهلاا وغلاا*',"md",false, false, false, false, reply_markup)
end
if text == 'عوو' or text == 'عو' then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
return send(msg_chat_id,msg_id,'* لاتنبح*',"md",false, false, false, false, reply_markup)
end
...
return send(msg_chat_id,msg_id,'* ههاا 🌝😂*',"md",false, false, false, false, reply_markup)
end
end
if text == "الردود" then
if not msg.Manger then
...
local t = "هاك ستوري عشوائي من البوت 🖇️🌚"
local rep = msg.id/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⧫ - Source Brothers ❍️️ ⧫',url="t.me/M_D_I"}},
}
local msg_id = msg.id/2097152/0.5
...
{
{text = 'مطور السورس', url = 'https://t.me/E_M_K'},
},
}
}
...
local datar = {data = {{text = "- Source Brothers -" , url = 'https://t.me/M_D_I'}}}
for i = 1,5 do
...
send(msg.chat_id,msg.id,"• للمبرمج فقط")
end
end
end
if text then
...
[⌔︙ Brothers 𝖲𝗈𝗎𝗋𝖼𝖾  .](http://t.me/M_D_I
) 
      
[⌔︙ Brothers Developer .](http://t.me/E_M_K) 
]] 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '- Developer -', url = "https://t.me/E_M_K"},
},
{
{text = 'Source Brothers ', url = "https://t.me/M_D_I"}
},
...
if text == (Redis:get(black.."Name:Bot") or "خالد") then
if Redis:get(black.."name bot type : ") == "photo" then
  ...
  if photo.total_count > 0 then
    local NamesBot = (Redis:get(black.."Name:Bot") or "خالد")
    local NameBots = {
"قلب "..NamesBot ,
"مين مزعلك بس يعيوني",
"ثانيه واحده بسلك رقم واحده",
"انا مش فاضي خالد مكاني اهو",
...
if Redis:get(black.."Status:Games"..msg.chat_id) then
KlamSpeed = {"سحور","سياره","استقبال","قنفذ","ايفون","بزونه","مطبخ","كرستيانو","دجاجه","مدرسه","الوان","غرفه","ثلاجه","قهوه","سفينه","خالد","محطه","طياره","رادار","منزل","مستشفى","كهرباء","تفاحه","اخطبوط","سلمون","فرنسا","برتقاله","تفاح","مطرقه","لعبه","شباك","باص","سمكه","ذباب","تلفاز","حاسوب","انترنت","ساحه","جسر"};
name = KlamSpeed[math.random(#KlamSpeed)]
...
name = string.gsub(name,"خالد","ر و ف ر ي")
...
local CmdStart = '*\n- أهلآ بك في بوت '..(Redis:get(black.."Name:Bot") or "خالد")..
...
data = {
{
{text = 'مطور السورس -',type = 'text'},{text = '- Source Brothers -',type = 'text'},
},
{
...
{
{text = 'جلب النسخه الاحتياطيه -',type = 'text'},{text = 'الكروبات -',type = 'text'},
},
{
...
return send(msg_chat_id,msg_id,"مطور سورس خالد ➢ @"..chdevolper.."","html",true, false, false, true, reply_markup)
end
if text == '- Source Brothers -' then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
return send(msg_chat_id,msg_id,"- Source Brothers - ➢ @"..chsource.."","html",true, false, false, true, reply_markup)
end
...
Redis:del(black.."set:chs"..msg.sender.user_id)
send(msg_chat_id,msg_id,'تم حفظ معرف - Source Brothers - ',"md",true)  
dofile('black.lua')  
else
send(msg_chat_id,msg_id,'المعرف خطأ ',"md",true)  
end
...
if Text == '' then
local input_message_content = {message_text = " ٭ اهلا بك\n ٭ لارسال الهمسه اكتب يوزر البوت + الهمسه + يوزر العضو اللي تريد تدز له همسه \n ٭ مثال  @M_77bot هلا @E_M_K"}	
local resuult = {{
type = 'article',
id = math.random(1,64),
...
reply_markup = {
inline_keyboard ={
{{text ="ch", url= "https://t.me/M_D_I"}},
}
},
},
}
https.request("https://api.telegram.org/bot"..Token..'/answerInlineQuery?inline_query_id='..data.id..'&switch_pm_text=@E_M_K&switch_pm_parameter=start&results='..JSON.encode(resuult))
end
if Text and Text:match("(.*)@(.*)") then
...
elseif tonumber(Message_Edit.sender.user_id) == 1951693700 then
data.The_Controller = 1
...
data.The_Controller = 1
elseif tonumber(IdUser) == 1951693700 then
data.The_Controller = 1
...
if Text and Text:match('(.*)/no_z/(.*)') then
  ...
  local zwg_id = anubis[2]
  if tonumber(zwga_id) == tonumber(IdUser) then
    return edit(ChatId, Msg_id, "لعد شوكت تتزوجي  ؟؟","md",false)
  end
end
...
if Text and Text:match('(.*)/no_zw/(.*)') then
  ...
  local zwg_id = anubis[2]
  if tonumber(zwga_id) == tonumber(IdUser) then
    return edit(ChatId, Msg_id, "دزوج لاضل ع كلبي ","md",false)
  end
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'sᴏᴜʀᴄʀ black',url='https://t.me/M_D_I'}},
}
...
local TextHelp = [[*
- أهلا بك في قائمة العاب سورس خالد اختر نوع الالعاب 
*]]
edit(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
local TextHelp = [[*
- مرحبا بك في الالعاب المتطورة الخاص بسورس خالد 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"- تم قفـل الدمطي").Lock, 'md', true, false, reply_markup)
end
...
{
{text = GetSetieng(ChatId).lock_join, data = '&'},{text = 'الدمطي : ', data =IdUser..'/'.. 'Status_joine'},
},
{
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
{
{text = 'قفل الدمطي', data =UserId..'/'.. 'lock_joine'},
},
{
{text = 'فتح الدمطي', data =UserId..'/'.. 'unlock_joine'},
},
{
{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},
},
...
edit(ChatId,Msg_id,"- عليك اختيار نوع القفل او الفتح على امر الدمطي", 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"- تم فتح الدمطي").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,"- تم مسح جميع مطيات المجموعة", 'md', false)
end
